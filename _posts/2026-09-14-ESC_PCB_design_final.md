...
**$R_{thJC}$** is the drain pad to copper term. it can be ignored here as themral conduction is basically super high and neglectable.

**$$R_{via}$$** is the vias term, in parrallel , there are also pretty neglectable. Per via it is given at $192.414°C/W$ according to the [RFTools.io clculator](https://rftools.io/calculators/pcb/via-thermal-resistance/). I have 50 in **parrallel** on this pour. To be conservative as not every one of them are as close to the heat source (even though I said it was isothermal but who cares), let's cut it to 30. This gives us **$6.4138 °C/W$**
...
$$P_{lossMax} \times R_{thJA} = (T_{max}-T{Ambiant})$$

$$P_{lossMax} = (T_{max}-T{Ambiant}) \div R_{thJA} = 85 / 85 = 1W$$
