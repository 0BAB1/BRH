...
We also, in the [part6 post](https://0bab1.github.io/BRH/posts/Trademaxxer_handling_collisions/), started to handle the reference using an hash function, drastically lowering the collision rate.
