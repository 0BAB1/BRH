...
* [Cocotbext.eth](https://github.com/alexforencich/cocotbext-eth) A cocotb library that auto-generates ethernet RGMII signals so we don't have to, huge time saver + robustness booster.
...
And that's exactly what it does ! which is great. I'll let you read its simple yet lifesaving docs if you are interested : [link](https://github.com/bbalouki/itch/tree/main).
...
<u><b>e.g.</b></u> I'm implementing R messages as I write these lines, and with python, I can just filter out frames that are not "R" so I can easily isolate my DUT behavior in this specific case.
